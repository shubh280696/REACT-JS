        ...
        <div>
            ...
            <footer id="footer">
                <div class="foot-col-1">
                    <div class="logo">
                        {/* <a href="#"><img src="//www.sofitmobile.com/images/sofit-icon.png"></a> */}
                    </div>
                ...
                <div class="foot-col-2">
                    ...
                    <p role="button" onClick={() => navigate("/")}>Home</p>
                    <p role='button' onClick={() => navigate ("/service")}>Service</p>
                    <p role='button' onClick={() => navigate ("/contact-us")}>Contact-us</p>
                    <p role='button' onClick={() => navigate ("/product")}>Product</p>
